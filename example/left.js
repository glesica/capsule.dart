// Generated by dart2js (fast startup emitter, strong), the Dart to JavaScript compiler version: 2.5.0.
...
(function dartProgram() {
  ...
  P = {
    ...
    _schedulePriorityAsyncCallback: function(callback) {
      var entry, t2,
        t1 = $._nextCallback;
      if (t1 == null) {
        $._nextCallback = $._lastCallback = new P._AsyncCallbackEntry(callback);
  ...
  D = {
    main: function() {
      ...
      J.setInnerHtml$1$x(container, "LEFT");
      P.Timer_Timer$periodic(new P.Duration(6000000), new D.main_closure(G._LeftApiLocal$(new D.LeftApiImpl(container, "LEFT"))));
    },
    main_closure: function main_closure(t0) {
      this.api = t0;
    },
    LeftApiImpl: function LeftApiImpl(t0, t1) {
      this._left$_target = t0;
      this._text = t1;
    }
  },
  G = {
    _LeftApiLocal$: function(_target) {
      var t1 = new G._LeftApiLocal(_target);
      t1._LeftApiLocal$1(_target);
      return t1;
    },
    _LeftApiLocal: function _LeftApiLocal(t0) {
      this._left_api$_target = t0;
    },
    _LeftApiLocal_closure: function _LeftApiLocal_closure(t0) {
      this.$this = t0;
    },
    _LeftApiLocal_closure0: function _LeftApiLocal_closure0(t0) {
      this.$this = t0;
    }
  };
  var holders = [C, H, J, P, W, D, G];
  ...
  D.main_closure.prototype = {
    call$1: function(_) {
      var t1 = this.api._left_api$_target;
      J.setInnerHtml$1$x(t1._left$_target, "LEFT");
      t1._text = "LEFT";
    },
    $signature: 18
  };
  D.LeftApiImpl.prototype = {$isLeftApi: 1};
  G._LeftApiLocal.prototype = {
    _LeftApiLocal$1: function(_target) {
      var t1 = P.Function,
        t2 = P.allowInterop(P.allowInterop(new G._LeftApiLocal_closure(this), t1), t1);
      capsule.listen("LeftApi", "clear", t2);
      t1 = P.allowInterop(P.allowInterop(new G._LeftApiLocal_closure0(this), t1), t1);
      capsule.listen("LeftApi", "setLeftText", t1);
    },
    $isLeftApi: 1
  };
  G._LeftApiLocal_closure.prototype = {
    call$0: function() {
      var t1 = this.$this._left_api$_target;
      J.setInnerHtml$1$x(t1._left$_target, "");
      t1._text = "";
    },
    "call*": "call$0",
    $requiredArgCount: 0,
  ...
  G._LeftApiLocal_closure0.prototype = {
    call$1: function(text) {
      var t1 = this.$this._left_api$_target;
      H.stringTypeCheck(text);
      J.setInnerHtml$1$x(t1._left$_target, text);
      t1._text = text;
    },
    $signature: 3
  };
  ...
  (function installTearOffs() {
    ...
    _static_0(P, "async___startMicrotaskLoop$closure", "_startMicrotaskLoop", 4);
  ...
  (function inheritance() {
    ...
    _inheritMany(P.Object, [H.JS_CONST, J.Interceptor, J.ArrayIterator, P.Iterable, H.ListIterator, P.Iterator, H.Symbol, P.MapView, H.ConstantMap, H.JSInvocationMirror, H.Closure, H.TypeErrorDecoder, P.Error, H._StackTrace, P.MapMixin, H.LinkedHashMapCell, H.LinkedHashMapKeyIterator, P._TimerImpl, P._AsyncCallbackEntry, P.Timer, P._Zone, P._SetBase, P._LinkedHashSetCell, P._LinkedHashSetIterator, P._ListBase_Object_ListMixin, P.ListMixin, P._UnmodifiableMapMixin, P.bool, P.num, P.Duration, P.StackOverflowError, P._Exception, P.Function, P.List, P.Null, P.String, P.StringBuffer, P.Symbol0, W._Html5NodeValidator, W.ImmutableListMixin, W.NodeValidatorBuilder, W._SimpleNodeValidator, W._SvgNodeValidator, W.FixedSizeListIterator, W.NodeValidator, W._SameOriginUriPolicy, W._ValidatingTreeSanitizer, D.LeftApiImpl, G._LeftApiLocal]);
    ...
    _inheritMany(H.Closure, [H.Primitives_functionNoSuchMethod_closure, H.unwrapException_saveStackTrace, H.TearOffClosure, H.initHooks_closure, H.initHooks_closure0, H.initHooks_closure1, P._AsyncRun__initializeScheduleImmediate_internalCallback, P._AsyncRun__initializeScheduleImmediate_closure, P._AsyncRun__scheduleImmediateJsOverride_internalCallback, P._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, P._TimerImpl_internalCallback, P._TimerImpl$periodic_closure, P._rootHandleUncaughtError_closure, P._RootZone_bindUnaryCallbackGuarded_closure, P.MapBase_mapToString_closure, P.NoSuchMethodError_toString_closure, P.Duration_toString_sixDigits, P.Duration_toString_twoDigits, W.Element_Element$html_closure, W.NodeValidatorBuilder_allowsElement_closure, W.NodeValidatorBuilder_allowsAttribute_closure, W._SimpleNodeValidator_closure, W._SimpleNodeValidator_closure0, W._TemplatingNodeValidator_closure, W._ValidatingTreeSanitizer_sanitizeTree_walk, D.main_closure, G._LeftApiLocal_closure, G._LeftApiLocal_closure0]);
  ...
  var init = {mangledGlobalNames: {int: "int", double: "double", num: "num", String: "String", bool: "bool", Null: "Null", List: "List"}, mangledNames: {}, getTypeFromName: getGlobalFromName, metadata: [], types: [{func: 1, ret: P.Null}, {func: 1, ret: -1, args: [{func: 1, ret: -1}]}, {func: 1, args: [,]}, {func: 1, ret: P.Null, args: [,]}, {func: 1, ret: -1}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, ret: P.bool, args: [W.NodeValidator]}, {func: 1, ret: P.bool, args: [P.String]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, ret: P.Null, args: [P.String,,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, ret: P.Null, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: P.Null, args: [P.Symbol0,,]}, {func: 1, ret: P.bool, args: [W.Node]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: -1, args: [W.Node, W.Node]}, {func: 1, ret: P.Null, args: [P.Timer]}], interceptorsByTag: null, leafTags: null};
  (function constants() {
