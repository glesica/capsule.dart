...
(function dartProgram() {
  ...
  G = {_LeftApiRemote: function _LeftApiRemote() {
    }},
  Q = {
    main: function() {
      var t1 = document,
        container = t1.querySelector("#right");
      container.toString;
      container.appendChild(t1.createTextNode("RIGHT"));
      P.Timer_Timer$periodic(new P.Duration(3000000), new Q.main_closure(new G._LeftApiRemote()));
    },
    main_closure: function main_closure(t0) {
      this.leftApi = t0;
    }
  };
  var holders = [C, H, J, P, W, G, Q];
  ...
  G._LeftApiRemote.prototype = {};
  Q.main_closure.prototype = {
    call$1: function(_) {
      var t1 = H.setRuntimeTypeInfo(["RIGHT :)"], [P.String]);
      capsule.send("LeftApi", "setLeftText", t1);
    },
    $signature: 8
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(P.Object, [H.JS_CONST, J.Interceptor, J.ArrayIterator, H.TypeErrorDecoder, P.Error, H.Closure, H._StackTrace, P._TimerImpl, P._AsyncCallbackEntry, P.Timer, P._Zone, P.bool, P.num, P.Duration, P.StackOverflowError, P._Exception, P.List, P.Null, P.String, P.StringBuffer, G._LeftApiRemote]);
    ...
    _inheritMany(P.Error, [H.NullError, H.JsNoSuchMethodError, H.UnknownJsTypeError, H.TypeErrorImplementation, H.RuntimeError, P.NullThrownError, P.ArgumentError, P.UnsupportedError, P.UnimplementedError, P.ConcurrentModificationError, P.CyclicInitializationError]);
    _inheritMany(H.Closure, [H.unwrapException_saveStackTrace, H.TearOffClosure, H.initHooks_closure, H.initHooks_closure0, H.initHooks_closure1, P._AsyncRun__initializeScheduleImmediate_internalCallback, P._AsyncRun__initializeScheduleImmediate_closure, P._AsyncRun__scheduleImmediateJsOverride_internalCallback, P._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, P._TimerImpl_internalCallback, P._TimerImpl$periodic_closure, P._rootHandleUncaughtError_closure, P._RootZone_bindUnaryCallbackGuarded_closure, P.Duration_toString_sixDigits, P.Duration_toString_twoDigits, Q.main_closure]);
